            ...
            switch (unserialize($_SESSION['user'])->getAccountType()) {
                    ...
                    if (!isset($_GET['ref'])) {   //TODO Make a page for choosing tests
                        if (!isset($_SESSION['id_user']) || $_SESSION['id_user']===null){
                            ...
                            if (!isset($_SESSION['id_test']) || $_SESSION['id_test']===null){
                                ...
                                require_once ('english/views/views_test/viewChooseTest.php');
                            }
                            else{
                                ...
                                require_once ('english/views/views_test/viewAdminStarted.php');
                            }
                        }
                ...
                case 0:
                    if (TestManager::checkToken()==0) {
                        ...
                        require_once('english/views/views_test/viewWaitLaunch.php');
                    }
                    else {
