                ...
                switch ($_GET['ref']){
                    ...
                    case 'list-driving-school':
                        if(!isset($_GET['search'])) {
                            require_once('english/views/views_administration/viewDrivingSchools.php');
                        }
                        else{
                            if ($_GET['search'] === 'delete'){
                                if(isset($_POST['delete'])){
                                    ...
                                    header('Location: '.URL.'en/administration/list-driving-school');
                                }
                            }
                        }
                        break;
                    ...
                    case 'modify-account':
                        ...
                        break;
                    case 'newaccount':
                        require_once('english/views/views_instructor/viewCreateUser.php');
                        break;
                    ...
                    case 'cgu':
                        ...
                        require_once ('english/views/views_administration/viewModifyCGU.php');
                        break;
