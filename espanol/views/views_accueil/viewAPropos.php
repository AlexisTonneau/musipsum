...
<div id="premiere_ligne_body">
    <div id="bordure_souris_body">
        <div class="a_propos_image_souris" align="center">
            ...
            <p class="titre_texte_a_propos">Ratón</p>
            <p>Obtenga más información sobre la constitución del ratón adaptado a la prueba.</p>
        </div>
    </div>
    <div id="bordure_stat_body" align="center">
        <div class="a_propos_image_stat">
            ...
            <p class="titre_texte_a_propos">Estadísticas</p>
            <p>Obtenga más información sobre estadísticas y mis resultados.</p>
        </div>
    </div>
    <div id="bordure_profils_body" align="center">
        <div class="a_propos_image_profils">
            ...
            <p class="titre_texte_a_propos">Perfiles</p>
...
<div id="deuxieme_ligne_body">
    <div id="bordure_voiture_body" align="center">
        <div class="a_propos_image_voiture">
            ...
            <p class="titre_texte_a_propos">Autoescuela </p>
            <p>Quiero saber más sobre mi autoescuela</p>
        </div>
    </div>
    <div id="bordure_permis_body" align="center">
        <div class="a_propos_image_permis">
            ...
            <p> Infórmese sobre las condiciones generales de uso.</p>
        </div>
    </div>
    <div id="bordure_like_body" align="center">
        <div class="a_propos_image_like">
            ...
            <p class="titre_texte_a_propos">Tu opinión nos interesa</p>
            <p> Siéntase libre de dejar una (¡buena!) Opinión en las diferentes redes sociales ...</p>
        </div>
    </div>
</div><?php
