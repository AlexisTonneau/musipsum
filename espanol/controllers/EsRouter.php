    ...
    public function routeReq()
    {
        ...
        try {
            ...
            spl_autoload_register(function ($class) {
                require_once('espanol/models/' . $class . '.php');
            });
            if (isset($_GET['link'])&&!is_null($_GET['link'])) {
                ...
                $controllerFile = 'espanol/controllers/' . $controllerClass . '.php';
                ...
                require_once('espanol/controllers/ControllerAccueil.php');
            ...
            require_once('espanol/views/viewError.php');
