...
<section class="middle_page">
    ...
    <div>
        ...
        <btn class="btn btn_cgu">
            <p class="centrer"><a class="centrer_compte" href="<?=URL?>instructor/newaccount">Modification CGU</a></p>
        </btn>
        <btn class="btn btn_autoecole">
            <p class="centrer"><a class="centrer_compte" href="<?=URL?>instructor/newaccount">Liste des auto-écoles</a></p>
        </btn>
        <btn class="btn btn_mentions_legales">
            <p class="centrer"><a class="centrer_compte" href="<?=URL?>instructor/newaccount">Modification Mention Légales</a></p>
        </btn>
    </div>
