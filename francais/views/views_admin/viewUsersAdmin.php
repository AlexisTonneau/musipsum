...
<div class="middle_page">
    ...
    <div>
        <btn class="btn btn_compte">
            <p class="centrer"><a class="centrer_compte" href="<?=URL?>francais/instructor/newaccount">Ouvrir un compte</a></p>
        </btn>
    </div>
    <div>
        <btn class="btn btn_capteurs">
            <p class="centrer"><a class="centrer_capteur" href="<?=URL?>francais/instructor/handlecaptor">Gérer</a></p>
        </btn>
    </div>
    <div class="btn_modifier">
        <a class="modifier" href="<?=URL?>francais/instructor/modify-drivingschool">Modifier l'auto-école</a>
    </div>
    <div class="btn_deconnexion">
            <a id="bouton_deconnecter" class="modifier" href="<?=URL?>francais/instructor/disconnect">Se déconnecter</a>
    </div>
</div>
