...
?>
    ...
    <form method="post" action="<?=URL?>francais/instructor/search" onsubmit="return checkForm()" class="form">
    ...
    <form method="post" action="<?=URL?>francais/instructor/search" class="modify">
