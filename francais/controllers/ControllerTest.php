...
class ControllerTest
{
    ...
    public function __construct()
    {
        ...
        if (isset($_SESSION['user']) && $_SESSION['user']!==null){
            switch (unserialize($_SESSION['user'])->getAccountType()) {
                ...
                case 1:
                    if (!isset($_GET['ref'])) {   //TODO Make a page for choosing tests
                        if (!isset($_SESSION['id_user']) || $_SESSION['id_user']===null){
                            ...
                            require_once 'francais/views/views_instructor/viewLaunchTest.php';
                        }
                        else{
                            if (!isset($_SESSION['id_test']) || $_SESSION['id_test']===null){
                                TestManager::sendModelId();
                                $tests_models = TestModel::getAllModels();
                                require_once ('francais/views/views_test/viewChooseTest.php');
                            }
                            else{
                                ...
                                require_once ('francais/views/views_test/viewAdminStarted.php');
                            }
                        }
                ...
                case 0:
                    if (TestManager::checkToken()==0) {
                        ...
                        require_once('francais/views/views_test/viewWaitLaunch.php');
                    }
                    else {

                        $url_fr = TestManager::findVideo(TestManager::checkToken());
                        require_once 'francais/views/views_test/viewTestStarted.php';
            ...
            require_once 'francais/views/views_test/viewNotConnected.php';
