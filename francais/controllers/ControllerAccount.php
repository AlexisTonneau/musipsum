...
class ControllerAccount
{
    ...
    public function __construct()
    {
        ...
        if(isset($_GET['ref']) && $_GET['ref'] === 'password_forget'){
            require_once('francais/views/views_connection/viewPassword.php');
        }
        ...
        if(isset($_SESSION['user'])) {
                ...
                elseif ($account->getAccountType()==Model::INSTRUCTOR_USER){
                        ...
                        require_once('francais/views/views_instructor/viewUsersAdmin.php');
                    ...
                    if (isset($_GET['ref']) && $_GET['ref'] === 'stat' ){
                        if(!isset($_GET['search'])){
                            ...
                            require_once ('francais/views/views_user/viewChooseTest.php');
                        }
                        else {
                            $test_searched = TestManager::searchById($_GET['search']);
                            require_once('francais/views/views_user/viewGraphs.php');
                        }
                    }
                    else {
                        require_once('francais/views/views_connection/viewUser.php');
                    }
                }
