    ...
    public function __construct()
    {
        if (isset($_SESSION['user']) && unserialize($_SESSION['user'])->getAccountType()==Model::ADMINISTRATOR_USER){
            ...
            if (!isset($_GET['ref']) || $_GET['ref']==null){
                ...
                require_once('francais/views/views_administration/viewAdmin.php');
                ...
                switch ($_GET['ref']){
                    ...
                    case 'disconnect':
                        ...
                        break;
                    case 'search':
                        require_once('francais/views/views_administration/viewAdminResearch.php');
                        break;
                    case 'list-driving-school':
                        if(!isset($_GET['search'])) {
                            require_once('francais/views/views_administration/viewDrivingSchools.php');
                        }
                        else{
                    ...
                    case 'modify-account':
                        ...
                        break;
                    case 'newaccount':
                        require_once('francais/views/views_instructor/viewCreateUser.php');
                        break;
                    ...
                    case 'cgu':
                        ...
                        require_once ('francais/views/views_administration/viewModifyCGU.php');
                        break;
                    case 'mentions-legales':
                        Administration::checkData();
                        require_once ('francais/views/views_administration/viewModifyML.php');
                        break;
                    case 'faq':
                        if(!isset($_GET['search'])) {
                            Faq::newFaq();
                            $faq = Faq::getFaq();
                            require_once('francais/views/views_administration/viewModifyFAQ.php');
                        }
                        else{
                            Faq::deleteFaq($_GET['search']);
                            header('Location: '.URL.'fr/administration/faq');
                        }
                        break;
                    default:
